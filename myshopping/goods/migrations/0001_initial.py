# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-10-19 09:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ImageField(default='static/images/goodstype/default.jpg', upload_to='static/images/goodstype/')),
        ...
        migrations.AddField(
            model_name='goods',
            name='store',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stores.Store', verbose_name='所属商店'),
        ),
    ]
